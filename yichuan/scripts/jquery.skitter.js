	...
	$sk.fn.extend({
		...
		start: function()
		{
			...
			if (this.settings.navigation) {
				...
				var $boxSkitter=this.box_skitter;
				$boxSkitter.mouseenter(function(){
					$(this).find('.prev_button').fadeIn(500);
					$(this).find('.next_button').fadeIn(500);
				}).mouseleave(function(){
					$(this).find('.prev_button').fadeOut(500);
					$(this).find('.next_button').fadeOut(500);
				});
